...
2. Sparsity of Connection : Parameter sharing을 통해 모든 image data를 넣는 것이 아니라, filter와 똑같은 size의 data를 input으로 넣어서 learning. **데이터가 분할되어 들어가 하나의 사진에서 많은 데이터를 얻음 -> Overfitting 방지**   
